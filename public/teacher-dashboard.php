            ...
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <h1 class="text-xl font-bold text-primary-700">Teacher Dashboard</h1>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <span class="text-gray-700">Welcome, <?php echo htmlspecialchars($teacher['name']); ?></span>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden mb-8">
            <div class="p-6 flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
                <div class="flex-shrink-0">
                    <img src="<?php echo !empty($teacher['image']) ? '../public/uploads/'.$teacher['image'] : '../assets/images/default-teacher.png'; ?>" 
                         alt="Teacher Image" 
            ...
            <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold mt-2"><?php echo count($student_notices) + count($general_notices); ?></h3>
                    </div>
            ...
            <div class="space-y-4">
                ...
                foreach($departments as $dept): ?>
                    <div class="border rounded-lg overflow-hidden">
                        <button class="w-full text-left p-4 bg-gray-50 hover:bg-gray-100 transition duration-200 flex justify-between items-center" 
                                onclick="toggleAccordion('dept-<?php echo $dept; ?>')">
                            <span class="font-medium text-gray-700">Department: <?php echo htmlspecialchars($dept); ?></span>
                            <i class="fas fa-chevron-down transition-transform duration-300" id="icon-dept-<?php echo $dept; ?>"></i>
                        </button>
                        <div class="hidden p-4 bg-white" id="dept-<?php echo $dept; ?>">
                            ...
                            foreach($semesters as $sem): ?>
                                <div class="mb-4 last:mb-0">
                                    <h4 class="font-medium text-gray-700 mb-2">Semester: <?php echo htmlspecialchars($sem); ?></h4>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php foreach($teacher_tests as $t): ?>
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo htmlspecialchars($t['department']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo htmlspecialchars($t['semester']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo htmlspecialchars($t['subject_name']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo htmlspecialchars($t['title']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo htmlspecialchars($t['type']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><?php echo date("d-M-Y H:i", strtotime($t['date_time'])); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            <button onclick="window.location.href='manage-tests.php?edit=<?php echo $t['id']; ?>'" 
                                                    class="text-indigo-600 hover:text-indigo-900 flex items-center">
                                                <i class="fas fa-edit mr-1"></i>Edit
                                            </button>
                                            <button onclick="if(confirm('Delete this test?')){ window.location.href='manage-tests.php?delete=<?php echo $t['id']; ?>'; }" 
                                                    class="text-red-600 hover:text-red-900 flex items-center">
                                                <i class="fas fa-trash mr-1"></i>Delete
                                            </button>
                                            <button onclick="window.location.href='view-test-students.php?test_id=<?php echo $t['id']; ?>'" 
                            ...
                            <div class="border rounded-lg p-4 hover:shadow-md transition duration-200">
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 mt-2">Student: <?php echo htmlspecialchars($n['student_name'].' ('.$n['student_roll'].')'); ?></p>
                                    </div>
                                    <div class="flex space-x-2">
                                        <button onclick="window.location.href='edit-student-notice.php?id=<?php echo $n['id']; ?>'" 
                                                class="text-indigo-600 hover:text-indigo-900 p-1 rounded">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button onclick="if(confirm('Are you sure to delete this notice?')) { window.location.href='delete-student-notice.php?id=<?php echo $n['id']; ?>'; }" 
                            ...
                            <div class="border rounded-lg p-4 hover:shadow-md transition duration-200">
                                <div class="flex justify-between items-start">
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        <button onclick="if(confirm('Are you sure to delete this notice?')) { window.location.href='delete-notice.php?id=<?php echo $n['id']; ?>'; }" 
                                                class="text-red-600 hover:text-red-900 p-1 rounded">
                                            <i class="fas fa-trash"></i>
                                        </button>
                                    </div>
    ...
    <footer class="bg-white border-t border-gray-200 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="md:flex md:items-center md:justify-between">
                <div class="text-center md:text-left">
                    <p class="text-sm text-gray-500">&copy; 2023 Teacher Dashboard. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
