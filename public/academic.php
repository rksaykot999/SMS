...
<body class="bg-gray-50 font-roboto">
  ...
  <section class="container mx-auto px-4 bg-white p-8 md:p-12 mt-12 rounded-3xl">
    <div class="flex-grow">
      <h1 class="text-3xl font-bold text-center mb-3">📚 Department Book List</h1>
                      ...
                      <table class="w-full table-auto">
                        ...
                        <tbody>
                          <tr class="hover:bg-blue-50">
                            ...
                            <td class="p-2 text-center">CST-201</td>
                            <td class="p-2 text-center">3.0</td>
                          </tr>
                          <tr class="hover:bg-blue-50">
                            <td class="p-2">Computer Architecture</td>
                            <td class="p-2 text-center">CST-202</td>
                            <td class="p-2 text-center">3.0</td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <div id="cstSem3" class="accordion-collapse hidden">
                    <div class="p-3">
                      <table class="w-full table-auto">
                        ...
                        <tbody>
                          <tr class="hover:bg-blue-50">
                            <td class="p-2">Algorithms</td>
                            <td class="p-2 text-center">CST-301</td>
                            <td class="p-2 text-center">3.0</td>
                          </tr>
                          <tr class="hover:bg-blue-50">
                            <td class="p-2">Database Systems</td>
                            <td class="p-2 text-center">CST-302</td>
                            <td class="p-2 text-center">3.0</td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <div id="cstSem4" class="accordion-collapse hidden">
                    <div class="p-3">
                      <table class="w-full table-auto">
                        ...
                        <tbody>
                          <tr class="hover:bg-blue-50">
                            <td class="p-2">Operating Systems</td>
                            <td class="p-2 text-center">CST-401</td>
                            <td class="p-2 text-center">3.0</td>
                          </tr>
                          <tr class="hover:bg-blue-50">
                            <td class="p-2">Software Engineering</td>
                            <td class="p-2 text-center">CST-402</td>
                            <td class="p-2 text-center">3.0</td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <div id="cstSem5" class="accordion-collapse hidden">
                    <div class="p-3">
                      <table class="w-full table-auto">
                        ...
                        <tbody>
                          <tr class="hover:bg-blue-50">
                            <td class="p-2">Computer Networks</td>
                            <td class="p-2 text-center">CST-501</td>
                            <td class="p-2 text-center">3.0</td>
                          </tr>
                          <tr class="hover:bg-blue-50">
                            <td class="p-2">Web Technologies</td>
                            <td class="p-2 text-center">CST-502</td>
                            <td class="p-2 text-center">3.0</td>
                          </tr>
                        </tbody>
                      </table>
                      ...
                      <table class="w-full table-auto">
                        ...
                        <tbody>
                          <tr class="hover:bg-blue-50">
                            ...
                            <td class="p-2 text-center">CST-601</td>
                            <td class="p-2 text-center">3.0</td>
                          </tr>
                          <tr class="hover:bg-blue-50">
                            <td class="p-2">Database Administration</td>
                            <td class="p-2 text-center">CST-602</td>
                            <td class="p-2 text-center">3.0</td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <div id="cstSem7" class="accordion-collapse hidden">
                    <div class="p-3">
                      <table class="w-full table-auto">
                        ...
                        <tbody>
                          <tr class="hover:bg-blue-50">
                            <td class="p-2">Machine Learning Basics</td>
                            <td class="p-2 text-center">CST-701</td>
                            <td class="p-2 text-center">3.0</td>
                          </tr>
                          <tr class="hover:bg-blue-50">
                            <td class="p-2">Information Security</td>
                            <td class="p-2 text-center">CST-702</td>
                            <td class="p-2 text-center">3.0</td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <div class="p-3">
                      <table class="w-full table-auto">
                        ...
                        <tbody>
                          <tr class="hover:bg-blue-50">
                            <td class="p-2">Capstone Project</td>
                            <td class="p-2 text-center">CST-801</td>
                            <td class="p-2 text-center">6.0</td>
                          </tr>
                          <tr class="hover:bg-blue-50">
                            <td class="p-2">Cloud Computing</td>
                            <td class="p-2 text-center">CST-802</td>
                            <td class="p-2 text-center">3.0</td>
                          </tr>
                        </tbody>
                      </table>
