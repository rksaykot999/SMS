...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $stmt = $pdo->prepare("INSERT INTO teachers (name, designation, department, shift, qualification, phone, email, image) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->execute([$name, $designation, $department, $shift, $qualification, $phone, $email, $image_name]);
